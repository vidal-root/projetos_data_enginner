...
total_substituir <- c('Sem informação','Pagamento em dia', 'Sem informação', 'Atraso no pagamento por um mês', 'Atraso no pagamento por dois meses', 'Atraso no pagamento por três meses',
